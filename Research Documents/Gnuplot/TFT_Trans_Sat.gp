...
set ylabel "Drain Current^{0.5} (A^{0.5})"
set yrange [-1E-12:]
set format y "%1.1E"
...
fit [10:20] f(x) IN_FILENAME using ($1):(sqrt($4)) via a, b
...
plot IN_FILENAME using ($1):(sqrt($4)) title "V_{ds} = 10 V" w l, \
